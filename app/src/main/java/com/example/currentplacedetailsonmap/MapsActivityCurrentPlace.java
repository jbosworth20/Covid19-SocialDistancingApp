...
public class MapsActivityCurrentPlace extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //ADDED: Set up buttons
        Button welcome_button = findViewById(R.id.welcome_button);
        Button survey_button = findViewById(R.id.survey_button);
        Button score_button = findViewById(R.id.score_button);

        welcome_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MapsActivityCurrentPlace.this,Welcome.class));
            }
        });
        ...
        survey_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MapsActivityCurrentPlace.this,HealthSurvey.class));
            }
        });
        score_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MapsActivityCurrentPlace.this,Score.class));
            }
        });
    }
